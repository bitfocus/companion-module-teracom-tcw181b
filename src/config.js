exports.getConfigFields = function () {
	return [
		...
		},
		{
			...
			width: 12,
			label: 'Information',
			value: 'Please fill out "Username" and "Password" if you have set "Web Access Authentication" to "Enabled" on your device. <br />Otherwise please leave it empty.'
		},
		{
			type: 'textinput',
			id: 'username',
		...
		},
		{
			...
			width: 12,
			label: 'Information',
			value: 'Please Check the box below, if you have set "XML/HTTP API Authentication" to "Enabled" on your device. (Default is OFF)'
		},
